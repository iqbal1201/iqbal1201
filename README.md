...
| **ML Engineering** | Machine Learning Engineer (MLE) that covers end-to-end ML project (model development, CI/CD, model deployment. Focus on project deployment using Docker and Kubernetes in Google Cloud GKE. | Python, Docker, Github Actions (CI/CD), Kubernetes, Scikit-learn, Kubeflow, Flask | [Repo Link](https://github.com/iqbal1201/mle_kubernetes) |
